class UserProfilesController < ApplicationController
  ...
  private
    ...
    def user_profile_params
      params.require(:user).permit(:name, :id_number, :avatar, :email, :city, :country, :location_privacy_option, :content_privacy_option, :job_privacy_option, :social_privacy_option)
    end
end
